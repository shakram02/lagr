...
class TftpProcessor(object):
   ...
   7         No such user.
    ...
    def process_udp_packet(self, packet_data, packet_source):
        #we use this function to process to packets to be send
        if packet_source == 1:
             self.request_file(packet_data)
             return self.get_next_output_packet()
    ...
    def ack(self, block_number):
        ...
        """
        req2 = bytearray([0,4,block_number[2],block_number[3]])
        self.packet_buffer.append(req2)
...
def main():
    ...
    if op_check == 1:
        ...
        do_socket_logic(tftp_processor.get_next_output_packet(), client_socket, server_address)
