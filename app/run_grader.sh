...
pytest -vv --tb=short app/lab1/test_run_clients.py | python app/lib/console_log_parser.py 1 client
pytest -vv --tb=short app/lab1/test_run_servers.py | python app/lib/console_log_parser.py 1 server
